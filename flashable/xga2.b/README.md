# XiGuaPerf(xga2.b) flashable
A script for flash XiGuaPerf(xga2.b) into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(181231)卡刷包](XiGuaPerf(xga2.b).Installer.181231.zip) 

		[(Download newest (181231) zip)](XiGuaPerf(xga2.b).Installer.181231.zip)
...
### 移除
-	下载 [XiGuaPerf(xga2.b) Remover](XiGuaPerf(xga2.b).Remover.zip) 并刷入

	Download [XiGuaPerf(xga2.b) Remover](XiGuaPerf(xga2.b).Remover.zip) and flash it
