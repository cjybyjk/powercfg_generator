# 西瓜调度 flashable
A script for flash 西瓜调度 into your device

Generated by [powercfg_generator VER:1.2.4](https://github.com/cjybyjk/powercfg_generator)
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(xga2_190206)卡刷包](xga2.Installer.xga2_190206.zip) 

		[(Download newest (xga2_190206) zip)](xga2.Installer.xga2_190206.zip)
...
### 移除
-	下载 [西瓜调度 Remover](西瓜调度.Remover.zip) 并刷入

	Download [西瓜调度 Remover](西瓜调度.Remover.zip) and flash it
