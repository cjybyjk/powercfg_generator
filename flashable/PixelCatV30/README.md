# 橘猫调度 for v30 flashable
A script for flash 橘猫调度 for v30 into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(Christmas.LG_V30.181225)卡刷包](橘猫调度 for v30.Installer.Christmas.LG_V30.181225.zip) 

		[(Download newest (Christmas.LG_V30.181225) zip)](橘猫调度 for v30.Installer.Christmas.LG_V30.181225.zip)
...
### 移除
-	下载 [橘猫调度 for v30 Remover](橘猫调度 for v30.Remover.zip) 并刷入

	Download [橘猫调度 for v30 Remover](橘猫调度 for v30.Remover.zip) and flash it
