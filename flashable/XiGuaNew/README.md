# XiGuaNew flashable
A script for flash XiGuaNew into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(181209)卡刷包](XiGuaNew.Installer.181209.zip) 

		[(Download newest (181209) zip)](XiGuaNew.Installer.181209.zip)
...
### 移除
-	下载 [XiGuaNew Remover](XiGuaNew.Remover.zip) 并刷入

	Download [XiGuaNew Remover](XiGuaNew.Remover.zip) and flash it
