# 星空调度 flashable
A script for flash 星空调度 into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(8.12.19)卡刷包](SkyMiPerf.Installer.8.12.19.zip) 

		[(Download newest (8.12.19) zip)](SkyMiPerf.Installer.8.12.19.zip)
...
### 移除
-	下载 [星空调度 Remover](星空调度.Remover.zip) 并刷入

	Download [星空调度 Remover](星空调度.Remover.zip) and flash it
