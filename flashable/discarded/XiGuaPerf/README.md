# XiGuaPerf(xga_final) flashable
A script for flash XiGuaPerf(xga_final) into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(final)卡刷包](XiGuaPerf(xga_final).Installer.final.zip) 

		[(Download newest (final) zip)](XiGuaPerf(xga_final).Installer.final.zip)
...
### 移除
-	下载 [XiGuaPerf(xga_final) Remover](XiGuaPerf(xga_final).Remover.zip) 并刷入

	Download [XiGuaPerf(xga_final) Remover](XiGuaPerf(xga_final).Remover.zip) and flash it
