# XiGuaPerf(xga3) flashable
A script for flash XiGuaPerf(xga3) into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(190204)卡刷包](XiGuaPerf(xga3).Installer.190204.zip) 

		[(Download newest (190204) zip)](XiGuaPerf(xga3).Installer.190204.zip)
...
### 移除
-	下载 [XiGuaPerf(xga3) Remover](XiGuaPerf(xga3).Remover.zip) 并刷入

	Download [XiGuaPerf(xga3) Remover](XiGuaPerf(xga3).Remover.zip) and flash it
