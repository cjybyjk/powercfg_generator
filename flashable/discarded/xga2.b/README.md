# XiGuaPerf(xga2.b_final) flashable
A script for flash XiGuaPerf(xga2.b_final) into your device

Generated by [powercfg_generator VER:1.1.33](https://github.com/cjybyjk/powercfg_generator)
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(final)卡刷包](XiGuaPerf(xga2.b_final).Installer.final.zip) 

		[(Download newest (final) zip)](XiGuaPerf(xga2.b_final).Installer.final.zip)
...
### 移除
-	下载 [XiGuaPerf(xga2.b_final) Remover](XiGuaPerf(xga2.b_final).Remover.zip) 并刷入

	Download [XiGuaPerf(xga2.b_final) Remover](XiGuaPerf(xga2.b_final).Remover.zip) and flash it
