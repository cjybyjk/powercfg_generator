# XiGuaPerf flashable
A script for flash XiGuaPerf into your device

Generated by [powercfg_generator VER:1.1.14](https://github.com/cjybyjk/powercfg_generator)
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(181209)卡刷包](XiGuaPerf.Installer.181209.zip) 

		[(Download newest (181209) zip)](XiGuaPerf.Installer.181209.zip)
...
### 移除
-	下载 [XiGuaPerf Remover](XiGuaPerf.Remover.zip) 并刷入

	Download [XiGuaPerf Remover](XiGuaPerf.Remover.zip) and flash it
