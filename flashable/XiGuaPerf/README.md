# XiGuaPerf(xga) flashable
A script for flash XiGuaPerf(xga) into your device
...
-   下载zip到你的设备中 
	...
	- [下载最新版本(xga2.181231)卡刷包](XiGuaPerf(xga).Installer.xga2.181231.zip) 

		[(Download newest (xga2.181231) zip)](XiGuaPerf(xga).Installer.xga2.181231.zip)
...
### 移除
-	下载 [XiGuaPerf(xga) Remover](XiGuaPerf(xga).Remover.zip) 并刷入

	Download [XiGuaPerf(xga) Remover](XiGuaPerf(xga).Remover.zip) and flash it
